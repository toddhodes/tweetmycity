...
/**
 * An in-memory implemention of {@link UserTokenStore}
 */
public class MemoryUserTokenStore
    ...
    */
   public synchronized Token get(User user) {
    ...
    */
   public synchronized void put(User user, Token token) {
