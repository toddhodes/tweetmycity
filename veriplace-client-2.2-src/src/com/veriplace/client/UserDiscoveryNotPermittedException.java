...
/**
 * Thrown to indicate that a {@link UserDiscoveryAPI} method failed because the
 * application does not have permission to identify the user.
 * @since 2.0
 */
public class UserDiscoveryNotPermittedException extends UserDiscoveryException {
