...
<body>
	...
	<div id="masthead">
    	Veriplace Weather Example (JSP)
	</div>

	<div id="mainContent">
	
		<div id="weather">
      <a href="http://www.wunderground.com/cgi-bin/findweather/getForecast?query=<vp:city/>,<vp:state/>&wuSelect=WEATHER">
      Weather Underground report for <vp:city/>, <vp:state/>
      </a>
		</div>
